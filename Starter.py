...
print "start"
os.system("ls /etc/NetworkManager/system-connections > IsItAlreadyThere.txt")
...
IsItAlreadyThere=open("IsItAlreadyThere.txt",'r')
if isNetworkAvailable(IsItAlreadyThere):
	os.system("nmcli con up id AdHocNetwork")
	print "AdHocNetwork Created."
elif isNetworkAvailable(report):
